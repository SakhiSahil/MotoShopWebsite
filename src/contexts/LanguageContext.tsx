...
const translations: Record<Language, Record<string, string>> = {
  fa: {
    ...
    'dealers.subtitle': 'شبکه نمایندگی‌های موتوشاپ در سراسر افغانستان',
    ...
    'contact.emailAddress': 'info@motoshop.af',
  ...
  en: {
    ...
    'dealers.subtitle': 'MotoShop dealership network across Afghanistan',
